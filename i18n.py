...
_STRINGS = {
    'en': {
        ...
        'invalid_initial_value': 'Initial value must be a number, true/false, or a string literal.',
        'warn_numeric_non_numeric': "Variable '{var}' used with numeric operator '{op}' may also be assigned a string or boolean.",
        ...
        'code_editor_tab': 'Code Editor (.bnov)',
        'validate_story': 'Validate',
        'run_story_btn': 'Run Story',
    ...
    'korean': {
        ...
        'update_started': '설치 프로그램이 실행되었습니다.\n잠시 뒤 프로그램이 종료될 수 있습니다',
        'no_content': '(내용 없음)',
        'input_values_required': '변수, 연산자, 값을 모두 입력하세요.',
        'input_var_init_required': '변수명과 초기값을 입력하세요.',
        'invalid_initial_value': '초기값은 숫자, true/false 또는 문자열 리터럴이어야 합니다.',
        'warn_numeric_non_numeric': "숫자 연산자 '{op}'에 사용된 변수 '{var}'가 문자열이나 불리언이 할당될 가능성이 있습니다.",
        ...
        'code_editor_tab': '코드 편집기(.bnov)',
        'validate_story': '유효성 검사',
        'run_story_btn': '스토리 실행',
        'search_scope': '찾기 범위',
        'this_branch': '이 분기',
